                ...
                @csrf
                    ...
                    <div class="box-body">
                        <div class="alert alert-info alert-dismissible" style="display: none;">
                            ...
                            <i class="fa fa-check"> </i> Perubahan Berhasil disimpan
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input  type="file" name="foto" class="form-control" id="foto" onchange="preview('.tampil-foto', this.files[0],100)">
                            <span class="help-block with-errors"></span>
                            <br>
                            <div class="tampil-foto">
                                <img src="{{ url($profil->foto ?? '/') }}" width="100">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="box-footer text-right">
                        <button class="btn btn-small btn-flat btn-primary"><i class="fa fa-save"></i> Simpan</button>
                    </div>
                    <br>
             </form>
            </div>
