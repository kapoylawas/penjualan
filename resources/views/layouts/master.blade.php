...
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('tempalate/bower_components/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- Morris.js charts -->
<script src="{{ asset('template/bower_components/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('tempalate/bower_components/morris.js/morris.min.js') }}"></script>
<!-- Sparkline -->
...
<!-- Slimscroll -->
<script src="{{ asset('tempalate/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
<!-- FastClick -->
